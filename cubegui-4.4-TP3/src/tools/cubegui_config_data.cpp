...
cubegui_config_data::la_object::la_object( void )
{
}

cubegui_config_data::la_object::la_object( const la_object& source ) :
...
cubegui_config_data::la_object::la_object( const string&        lib_name,
...
cubegui_config_data::la_object::~la_object()
{
}

/* ****************************************************************************
                                                         class cubegui_config_data
******************************************************************************/

cubegui_config_data::cubegui_config_data( void )
{
}

cubegui_config_data::~cubegui_config_data()
{
}

string
cubegui_config_data::GetLibraries( const deque<string>& inputLibs )
{
    /* Traversing backwards will add the -l flags from the cubegui_* lib last.
...
string
cubegui_config_data::GetLDFlags( const deque<string>& libs )
{
...
string
cubegui_config_data::GetRpathFlags( const deque<string>& libs )
{
    deque<string>           deps = get_dependencies( libs );
    deque<string>           flags;
    deque<string>::iterator i;
...
void
cubegui_config_data::prepare_rpath_flags( void )
{
...
deque<string>
cubegui_config_data::remove_system_path( const deque<string>& pathList )
{
...
string
cubegui_config_data::append_ld_run_path_to_rpath( const string& rpath )
{
...
deque<string>
cubegui_config_data::get_dependencies( const deque<string>& libs )
{
...
string
cubegui_config_data::prepare_string( const string& str )
{
    string       result( str );
