...
void cube::ScaleFuncValue::fromStream( Connection& connection )
{
    /// @todo FIXME Provide implementation for ScaleFuncValue::fromStream
}

void cube::ScaleFuncValue::toStream( Connection& connection ) const
{
    /// @todo FIXME Provide implementation for ScaleFuncValue::toStream
}
