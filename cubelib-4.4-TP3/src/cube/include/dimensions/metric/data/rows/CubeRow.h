...
public:
    ...
    Value*
    sumRow( row_t );                // / summs up the all elements in a row using algebra of a value.
    ...
    template <class T>
    T
    sumBuildInTypeRow( row_t );                // / summs up the all elements in a row using algebra of a value.
...
template <class T>
T
Row::sumBuildInTypeRow( row_t _row )
{
    if ( _row == NULL )
    {
