...
cubelib_config_data::la_object::la_object( void )
{
}

cubelib_config_data::la_object::la_object( const la_object& source ) :
...
cubelib_config_data::la_object::la_object( const string&        lib_name,
...
cubelib_config_data::la_object::~la_object()
{
}
...
cubelib_config_data::cubelib_config_data( void )
{
}
...
{
    /* Traversing backwards will add the -l flags from the cubelib_* lib last.
...
void
cubelib_config_data::prepare_rpath_flags( void )
{
...
deque<string>
cubelib_config_data::remove_system_path( const deque<string>& pathList )
{
...
string
cubelib_config_data::append_ld_run_path_to_rpath( const string& rpath )
{
...
deque<string>
cubelib_config_data::get_dependencies( const deque<string>& libs )
{
