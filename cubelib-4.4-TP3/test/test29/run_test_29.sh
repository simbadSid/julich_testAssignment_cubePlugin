...
TEMPLATE_DIR="/home/kassuskley/Desktop/khedma/internship/julich/assignment/report/cubelib-4.4-TP3/build-frontend/../test/test29"
...
../cube_cmp remap.cube $TEMPLATE1_CUBE
result3=$?
...
../cube_cmp remap2.cube $TEMPLATE2_CUBE
result6=$?
...
../cube_cmp file-exp1.cube $TEMPLATE3_CUBE
result11=$?

echo "=====> Compare result with previosly created file (exp2 vs derived) "
../cube_cmp file-exp2.cube $TEMPLATE4_CUBE
result12=$?
